...
def test_timage_formatting():
    ...
    max_width = layout_config.content_width

    # 1. Plain text
    img1 = get_timage("Hello World!", max_width, text_config)
    img1.save(f"{output_dir}/plain.png")

    # 2. Bold Red
    img2 = get_timage("#b#ff0000#Bold Red Text#", max_width, text_config)
    img2.save(f"{output_dir}/bold_red.png")

    # 3. Italic Green
    img3 = get_timage("#i#00ff00#Italic Green Text#", max_width, text_config)
    img3.save(f"{output_dir}/italic_green.png")

    # 4. Bold Italic Blue
    img4 = get_timage("#bi#0000ffff#Bold Italic Blue Text#", max_width, text_config)
    img4.save(f"{output_dir}/bold_italic_blue.png")

    # 5. Right Aligned
    text_config_right = replace(text_config, horizontal_align="right")
    img5 = get_timage("Right Aligned Text", max_width, text_config_right)
    img5.save(f"{output_dir}/right_aligned.png")

    # 6. Center Aligned in larger canvas
    img6 = get_timage("#b#ffffff#Centered in 400px height#", max_width, text_config, max_height=400)
